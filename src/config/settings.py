...
class PdfSettings(BaseSettings):
    ...
    company_name: str = "SRG Company"
    company_address: str = ""
    company_phone: str = ""
    company_email: str = ""
    footer_text: str = "Generated by SRG Invoice System"
    logo_path: str = ""  # Path to logo image file (PNG/JPG)
    arabic_font_path: str = ""  # Path to TTF font supporting Arabic glyphs
